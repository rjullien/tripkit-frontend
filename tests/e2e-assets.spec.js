...
// Load Canada seed to test map feature
const seedCode = readFileSync(join(__dirname, '..', 'js', 'seed', 'canada-2026.js'), 'utf8');
const fn = new Function(seedCode + '; return SEED_CANADA_2026;');
const SEED = fn();
